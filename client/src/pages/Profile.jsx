  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <img onClick={() => fileRef.current.click()} src={formData.avatar || currentUser.avatar} alt="profile" className="rounded-full h-24 w-24 object-cover cursor-pointer self-centre mt-2 m-auto" />
        ...
        <Link className='bg-green-700 text-white p-3 rounded-lg uppercase text-centre hover:opacity-95' to={"/create-listing"} >Create Listing</Link>
      </form>
